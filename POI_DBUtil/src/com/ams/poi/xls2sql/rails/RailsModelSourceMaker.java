 ...
 * 
 */
package com.ams.poi.xls2sql.rails;
 ...
 *
 */
public class RailsModelSourceMaker {
//	private String app_cd_name;
	...
	private String getHeaderComment(WebAPIMethod m) {
		String s = "#\n"
				...
				+ ")テーブルと対応するModel</p>\n\n"
				+ "# @author \n"
				+ "# @version $Id: RailsModelSourceMaker.java 100 2009-11-27 08:54:08Z amonden $\n"
				+ "#\n";
	...
	private String getClassSource(WebAPIMethod m, TableDef td) {
		...
		// 1. クラス定義 start
		sb.append("class "+class_name+" < ActiveRecord::Base\r\n");
		sb.append("end\r\n");
