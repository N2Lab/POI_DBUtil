...
import com.ams.poi.xls2sql.sqltypes.DB2FieldTypes;

/**
 * <p>タイトル: DB2InsertSQL</p>
 * <p>説明: </p>
 ...
 * @version $Revision: 69 $
 */
public class DB2InsertSQL extends InsertSQL {
	...
	public String getInsertSQL(TableValuesDef tvd, ArrayList rec_list)
		...
		while(it.hasNext()) {
			...
			out.append(DB2FieldTypes.getInsertType(val, (FieldDef)flist.get(c)));
