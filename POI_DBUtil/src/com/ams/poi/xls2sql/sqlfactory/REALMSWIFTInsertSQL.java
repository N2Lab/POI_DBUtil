 ...
 */
public class REALMSWIFTInsertSQL extends InsertSQL {

	/**
	 * 
	 */
	public REALMSWIFTInsertSQL() {
		super();
	}
	...
	public String getInsertSQL(TableValuesDef tvd, ArrayList rec_list)
		...
		// １レコード分のINSERTを出力
//		StringBuffer out = new StringBuffer("    // add proc realm swift INSERT INTO " + table_name + " VALUES(");
